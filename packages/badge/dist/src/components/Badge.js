...
const Badge = ({ children, ...passThroughProps }) => {
    const defaultProps = {
        ...passThroughProps,
    ...
    return React.createElement(BadgeWrapper, { ...defaultProps }, children);
};
Badge.displayName = 'Badge';
export default withDeprecation(withTheme(Badge, THEME_NAME), `The following items are deprecated:
