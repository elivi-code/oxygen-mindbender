...
const dateTimeRangeSelector: DateTimeRangeSelectorTheme = {
  ...dateTimeSelector,
  ...
  listItemPaddingHorizontal: `${
    parseInt(spacing.sm, 10) - 2 * parseInt(size.borderSizeDefault, 10)
  }px`,
  ...
  listInputMarginBottom: `-${
    parseInt(spacing.xs, 10) - 2 * parseInt(size.borderSizeDefault, 10)
  }px`,
  listInputMarginLeft: spacing.xxs,
  listInputMarginRight: `${
...
const commonProps: Pick<
  DateTimeRangeSelectorTheme,
  | 'width'
  | 'containerPadding'
  | 'calendarHorizontalMargin'
  | 'calendarBottomMargin'
  | 'dateTimeInputsPadding'
  | 'dateTimeInputsMarginBottom'
  | 'dateTimeInputsBorderSize'
  | 'dateInputMarginRight'
  | 'timeInputMarginRight'
  | 'timeInputContainerMarginLeft'
  | 'endTimeErrorFontSize'
  | 'endTimeErrorLineHeight'
  | 'listBorderRightSize'
  | 'listWidth'
  | 'listItemFontSize'
  | 'listItemLineHeight'
...
> = {
  ...
  listItemPaddingHorizontal: `${
    parseInt(light.spacing04, 10) - 2 * parseInt('1px', 10)
  }px`,
  listItemSelectedWidth: '4px',
  listInputMarginTop: `-${
    parseInt(light.spacing03, 10) - parseInt('1px', 10)
  }px`,
  listInputMarginBottom: `-${
    parseInt(light.spacing03, 10) - 2 * parseInt('1px', 10)
  }px`,
  listInputMarginLeft: light.spacing02,
  listInputMarginRight: `${
    parseInt(light.spacing02, 10) - parseInt('1px', 10)
  }px`,
...
const dateTimeRangeSelectorNovo: DateTimeRangeSelectorTheme = {
  ...dateTimeSelectorNovo,
  ...commonProps,
...
const dateTimeRangeSelectorNovoDark: DateTimeRangeSelectorTheme = {
  ...dateTimeSelectorNovoDark,
  ...commonProps,
...
const dateTimeRangeSelectorNeoLight: DateTimeRangeSelectorTheme = {
  ...dateTimeSelectorNeoLight,
  ...commonProps,
...
const dateTimeRangeSelectorNeoDark: DateTimeRangeSelectorTheme = {
  ...dateTimeSelectorNeoDark,
  ...commonProps,
...
export {
  ...
  dateTimeRangeSelectorNeoLight,
  dateTimeRangeSelectorNeoDark,
};
