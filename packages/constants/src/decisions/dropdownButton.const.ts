...
export interface DropdownButtonTheme {
  button: ButtonTheme;
  indicatorLeftMargin: string;
  indicatorScale: number;
  indicatorColor: string;
  indicatorColorDisabled: string;
...
const dropdownButton: DropdownButtonTheme = {
  button: {
    ...button,
  },
...
const dropdownButtonNovo: DropdownButtonTheme = {
  isClassic: false,
...
const dropdownButtonNovoDark: DropdownButtonTheme = {
  ...dropdownButtonNovo,
...
const dropdownButtonNeoLight: DropdownButtonTheme = {
  ...dropdownButtonNovo,
...
const dropdownButtonNeoDark: DropdownButtonTheme = {
...
export {
  ...
  dropdownButtonNovo,
  dropdownButtonNovoDark,
  dropdownButtonNeoLight,
  dropdownButtonNeoDark,
};
