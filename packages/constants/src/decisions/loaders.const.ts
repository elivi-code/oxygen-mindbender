...
const loadersNovo: LoadersTheme = {
  ...loaders,
  ...light.body01,
...
const loadersNovoDark: LoadersTheme = {
  ...loadersNovo,
...
const loadersNeoLight: LoadersTheme = {
  ...loadersNovo,
...
const loadersNeoDark: LoadersTheme = {
  ...loadersNovoDark,
