...
const contextMenu: ContextMenuTheme = {
...
const contextMenuNovo: ContextMenuTheme = {
  isClassic: false,
...
const contextMenuNovoDark: ContextMenuTheme = {
  ...contextMenuNovo,
...
const contextMenuNeoLight: ContextMenuTheme = {
  ...contextMenuNovo,
...
const contextMenuNeoDark: ContextMenuTheme = {
  ...contextMenuNovoDark,
