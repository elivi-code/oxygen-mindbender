...
const dateTimeSelector = {
    ...
    paddingVerticalSmall: `${parseInt(spacing.xxs, 10) - parseInt(size.borderSizeDefault, 10)}px`,
    paddingVerticalLarge: `${parseInt(spacing.xs, 10) - parseInt(size.borderSizeDefault, 10)}px`,
...
const dateTimeSelectorNovo = {
    ...
    paddingVerticalSmall: `${parseInt(light.spacing02, 10) - parseInt('2px', 10)}px`,
    paddingVerticalLarge: `${parseInt(light.spacing03, 10) - parseInt('2px', 10)}px`,
...
const dateTimeSelectorNovoDark = {
...
const dateTimeSelectorNeoLight = {
    ...dateTimeSelectorNovo,
