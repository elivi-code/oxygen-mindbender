...
import { textLink, textLinkNovo, textLinkNovoDark, textLinkNeoLight, textLinkNeoDark, } from './textLink.const';
...
const toast = {
    ...
    padding: `${parseInt(size.default2x, 10) - verticalPaddingOffset}px ${size.default2x}`,
    maxHeight: '120px',
    maxWidth: '100%',
    stackMargin: '16px',
...
const inlineNotification = { ...toast, borderColor: undefined };
const toastNovo = {
    isClassic: false,
    // Sizes
    toastSmall: '320px',
