import { alertBanner, alertBannerNovo, alertBannerNovoDark, } from '../decisions/alertBanner.const';
import { avatar, avatarNovo, avatarNovoDark } from '../decisions/avatar.const';
import { avatarStack, avatarStackNovo, avatarStackNovoDark, } from '../decisions/avatarStack.const';
import { badge, badgeNovo, badgeNovoDark } from '../decisions/badge.const';
import { breadcrumbs, breadcrumbsNovo, breadcrumbsNovoDark, } from '../decisions/breadcrumbs.const';
import { button, buttonNovo, buttonNovoDark } from '../decisions/button.const';
import { calendar, calendarNovo, calendarNovoDark, } from '../decisions/calendar.const';
import { checkbox, checkboxNovo, checkboxNovoDark, checkboxGroup, checkboxGroupNovo, checkboxGroupNovoDark, } from '../decisions/checkbox.const';
import { dateTimeRangeSelector, dateTimeRangeSelectorNovo, dateTimeRangeSelectorNovoDark, } from '../decisions/dateTimeRangeSelector.const';
import { dateTimeSelector, dateTimeSelectorNovo, dateTimeSelectorNovoDark, } from '../decisions/dateTimeSelector.const';
import { dropdownButton, dropdownButtonNovo, dropdownButtonNovoDark, } from '../decisions/dropdownButton.const';
import { eventCard, eventCardNovo, eventCardNovoDark, } from '../decisions/eventCard.const';
import { icon, iconNovo, iconNovoDark } from '../decisions/icon.const';
import { iconButton, iconButtonNovo, iconButtonNovoDark, } from '../decisions/iconButton.const';
...
import { radio, radioNovo, radioNovoDark, radioGroup, radioGroupNovo, radioGroupNovoDark, } from '../decisions/radio.const';
import { overlay, overlayNovo, overlayNovoDark, } from '../decisions/overlay.const';
import { staticTooltip, staticTooltipNovo, staticTooltipNovoDark, } from '../decisions/static-tooltip.const';
...
import { loaders, loadersNovo, loadersNovoDark, } from '../decisions/loaders.const';
import { tabs, tabsNovo, tabsNovoDark } from '../decisions/tabs.const';
import { tag, tagNovo, tagNovoDark } from '../decisions/tag.const';
import { textLink, textLinkNovo, textLinkNovoDark, } from '../decisions/textLink.const';
import { timeSelector, timeSelectorNovo, timeSelectorNovoDark, } from '../decisions/timeSelector';
import { toast, toastNovo, toastNovoDark, inlineNotificationNovo, inlineNotificationNovoDark, inlineNotification, } from '../decisions/toast.const';
import { textField, textFieldNovo, textFieldNovoDark, } from '../decisions/textField.const';
import { toggleButton, toggleButtonGroup, toggleButtonNovo, toggleButtonNovoDark, toggleButtonGroupNovo, toggleButtonGroupNovoDark, } from '../decisions/toggleButton.const';
import { userStatus, userStatusNovo, userStatusNovoDark, } from '../decisions/userStatus.const';
...
import { contextMenu, contextMenuNovo, contextMenuNovoDark, } from '../decisions/contextMenu.const';
import typography from '../decisions/typography.const';
import { textarea, textareaNovo, textareaNovoDark, } from '../decisions/textarea.const';
import { card, cardNovo, cardNovoDark, statistics, statisticsNovo, statisticsNovoDark, } from '../decisions/card.const';
const classicTheme = {
    alertBanner,
    avatar,
    avatarStack,
