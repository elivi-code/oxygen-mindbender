...
import { getActiveBackground, getDefaultBackground, getHoverBackground, } from './iconButton.utils';
export const IconButtonStyled = styled.button `
  ...
  `}
  &:focus-visible {
    border-color: ${({ theme, isInverted }) => isInverted ? theme.borderFocusInverted : theme.borderFocus};
    box-shadow: 0 0 0 2px
      ${({ theme, isInverted }) => isInverted ? theme.shadowFocusInverted : theme.shadowFocus}
      inset;
  }
`;
