...
const DropdownButtonComponent = styled.button<
  Omit<DropdownButtonProps, 'isDisabled' | 'isActive' | 'fullWidth'> & {
    $fullWidth: DropdownButtonProps['fullWidth'];
    $isActive: DropdownButtonProps['isActive'];
  }
>`
  display: flex;
...
const iconSizeMap: Record<DropdownButtonProps['size'], number> = {
  large: 24,
  medium: 20,
  small: 16,
};
