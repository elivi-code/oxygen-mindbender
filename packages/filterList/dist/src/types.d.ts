...
export type OperatorValueType = 'is' | 'isNot' | 'contains' | 'notContains' | 'startsWith' | 'endsWith' | 'notStartsWith' | 'notEndsWith' | 'equals' | 'notEquals' | 'lessThan' | 'lessThanOrEqual' | 'greaterThan' | 'greaterThanOrEqual' | 'dateRange' | 'boolean';
export declare const OPERATOR_TYPES_STRING: {
    [key: string]: OperatorValueType;
};
export declare const OPERATOR_TYPES_NUMBER: {
    [key: string]: OperatorValueType;
};
export declare const OPERATOR_TYPES_DATE: {
    [key: string]: OperatorValueType;
};
export declare const OPERATOR_TYPES_BOOLEAN: {
    [key: string]: OperatorValueType;
};
export declare const OPERATOR_TYPES: {
    readonly [x: string]: OperatorValueType;
};
export type OperatorType = {
    value: OperatorValueType;
    label?: string;
};
export declare const multiSelectionOperators: OperatorValueType[];
...
type DateTimeRangeProps = Omit<DateTimeRangePickerProps, 'setOuterState' | 'id' | 'onRangeChange' | 'theme' | 'predefinedRange' | 'dateTimeRange' | 'testId' | 'headerRenderer'>;
...
export interface FilterListInterface {
    ...
    getSearchSuggestions?(filterId: FilterType['id'], filterSearch: FilterValueType, pageKeyOffset: number): Promise<never> | Promise<{
