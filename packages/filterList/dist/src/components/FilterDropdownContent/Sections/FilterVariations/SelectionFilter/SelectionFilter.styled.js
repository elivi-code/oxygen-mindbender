...
const Container = styled.div `
  ...
  padding: ${({ theme }) => `0 ${theme.spacing03} ${theme.spacing03} ${theme.spacing03}`};
...
const FreeformLabel = styled.div `
  ...
  color: ${({ theme }) => theme.textColor02};
`;
export { Container, OptionsContainer, SelectedLegend, SelectedFieldset, LoaderContainer, NoResultsLabel, CheckboxWrapper, FreeformLabel, };
