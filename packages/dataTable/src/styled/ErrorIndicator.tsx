...
const getRowStatusColor = ({ rowStatusType, theme }: GetRowStatusColor) => {
...
const Warning = styled.div<{ rowStatusType: RowStatusType }>`
...
const WarningIndicator = ({ rowStatusType }: Props) => (
  <WarningContainer>
    <Warning rowStatusType={rowStatusType} />
  </WarningContainer>
);
