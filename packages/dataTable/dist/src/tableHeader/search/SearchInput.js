...
const SearchInput = ({ filters, resultsSizeLimit = 8, listTotalResults, initialSearchResults, appliedSearchValue = '', searchTranslations, getSearchResults, onSearchResultSelect, onSearchChange, onDataRetrievalError, onSearchResultsChange, testId = 'search-input', }) => {
    ...
    const onViewAllResults = useCallback((value) => {
    ...
    const keywordSearchOnSearchChange = useMemo(() => debounce(setSearchValue, 250), [setSearchValue]);
    useEffect(() => {
    ...
    return (React.createElement(KeywordSearch, { testId: testId, size: "default", onFetchSearchResults: onFetchSearchResults, storedSearchValue: appliedSearchValue, onSearchResultSelect: onSearchResultSelect, isLoading: isLoading, onSearchChange: keywordSearchOnSearchChange, onViewAllResults: onViewAllResults, searchResultsCount: searchResultsCount || 0, searchResults: results.temporary || results.applied, searchResultsSizeLimit: resultsSizeLimit, onClear: onClear, translations: searchTranslations }));
};
export { SearchInput };
