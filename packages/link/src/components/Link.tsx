...
import { iconSizeMap, LinkProps, StyledLinkBaseProps } from '../types';
...
const Link = forwardRef<HTMLAnchorElement, LinkProps>(
  (
    { children, standalone = false, isChat = false, testId = 'LINK', ...props },
    ref,
  ) => {
    ...
    return (
      <StyledLink
        ...
        size={standalone ? size : undefined}
        isChat={isChat}
        isHovered={isHovered}
        isFocused={isFocused}
        isActive={isActive}
