 ...
 */
export declare function getMenuAriaLabel({ menuItemLabel, badgeAriaLabel, hasBadge, }: GetMenuAriaLabelParams): string;
export {};
//# sourceMappingURL=menuAriaLabelUtils.d.ts.map