 ...
 */
export const FloatingUIWrapper = React.forwardRef<
  HTMLElement,
...
>(
  (
    ...
    const listItemsRef = React.useRef<Array<HTMLDivElement | null>>([]);
    ...
    const { getReferenceProps, getFloatingProps, getItemProps } =
      useInteractions([hover, dismiss, click, listNavigation]);
    ...
    return (
      <>
        {isOpen && (
          <FloatingFocusManager context={context} modal={false} closeOnFocusOut>
            <FloatingContainer
              ...
              {...getFloatingProps()}
              {...getTestAttributes(`${testId}_FLOATING_UI`)}
            >
              <FloatingArrow
                ref={arrowRef}
                context={context}
        ...
        {/* the button appearing on the sidebar */}
        <Button
          ref={referenceRef}
          {...customButtonProps}
          ...
          $isActive={isActive}
          {...getTestAttributes(`${testId}_FLOATING_UI_TRIGGER`)}
        >
          <MenuBadge
