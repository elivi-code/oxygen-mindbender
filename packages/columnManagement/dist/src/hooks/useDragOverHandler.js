...
export function useDragOverHandler({ items, setItems, activeContainerDragEnd, setIsAvailableColumnRemovable, }) {
    const handleDragOver = (event) => {
        ...
        setItems(prev => {
            ...
            return {
                ...
                [overContainer]: addElementAtPosition(overItems, activeItems[activeIndex], newIndex),
            };
        });
    };
