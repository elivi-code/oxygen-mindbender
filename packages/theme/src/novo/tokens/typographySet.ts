...
export const label01: TypographySet = {
...
export const labelBold01: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
  fontSize: typography.fontSize4xs,
  lineHeight: lineHeightLabel,
...
export const body01: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
...
export const bodyBold01: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
  fontSize: typography.fontSize3xs,
  lineHeight: lineHeightBody01,
  fontWeight: typography.fontWeightSemiBold,
...
export const body02: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
...
export const bodyBold02: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
  fontSize: typography.fontSize2xs,
  lineHeight: lineHeightBody02,
  fontWeight: typography.fontWeightSemiBold,
...
export const bulletList01: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
  fontSize: typography.fontSize3xs,
...
export const heading01: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
...
export const heading02: TypographySet = {
  fontFamily: typography.fontFamilyPrimary,
