...
export interface AvatarProps extends Omit<React.ComponentPropsWithRef<'div'>, 'onClick'> {
...
export interface AvatarStackProps extends React.ComponentPropsWithRef<'button'> {
