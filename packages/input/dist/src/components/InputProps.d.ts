...
export type InputDefaultProps = Required<Pick<InputProps, 'autoFocus' | 'autoPrefixWidth' | 'autoSuffixWidth' | 'fixed' | 'focus' | 'fullWidth' | 'hasError' | 'isDisabled' | 'isReadOnly' | 'isRequired' | 'placeholder' | 'prefix' | 'size' | 'suffix' | 'testId' | 'type'>>;
export {};
